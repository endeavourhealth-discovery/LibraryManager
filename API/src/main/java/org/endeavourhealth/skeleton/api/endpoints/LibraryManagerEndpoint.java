...
import org.endeavourhealth.skeleton.api.logic.LibraryManagerLogic;
...
public class LibraryManagerEndpoint {

    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    @Timed(absolute = true, name="Template.LibraryManagerEndpoint.Message.Get")             // TODO: metrics name <application>.<endpoint>.<path>.<method>
    @Path("/message")
    ...
    public Response get(@Context SecurityContext sc,
        ...
        String result = new LibraryManagerLogic().getMessage(name);
