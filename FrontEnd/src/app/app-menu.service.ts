...
export class AppMenuService implements  AbstractMenuProvider {
  static getRoutes(): Routes {
    return [
      { path: '', redirectTo : 'libraryManager', pathMatch: 'full' }, // Default route
      {path: 'libraryManager', component: SettingsComponent}
    ];
  }
  ...
  getMenuOptions(): MenuOption[] {
    return [
      {caption: 'Library Manager module', state: 'skeleton', icon: 'fa fa-user', role: 'eds-user-manager:user-manager'},
